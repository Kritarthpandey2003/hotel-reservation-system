  ...
  return (
    <div className="flex h-screen w-full bg-background font-sans text-text-main overflow-hidden">
      ...
      <div className="flex-1 flex flex-col h-full overflow-hidden">
        ...
        {/* Dashboard Content */}
        <main className="flex-1 overflow-y-auto lg:overflow-hidden flex flex-col lg:flex-row p-4 gap-4 bg-background pb-24 lg:pb-4">
      ...
      <nav className="lg:hidden fixed bottom-0 left-0 right-0 bg-surface border-t border-border flex justify-around items-center h-16 px-2 z-50 shadow-[0_-4px_6px_-1px_rgba(0,0,0,0.05)]">
        <button onClick={() => setActiveTab('allocation')} className={`flex flex-col items-center justify-center w-full h-full ${activeTab === 'allocation' ? 'text-primary' : 'text-text-muted'}`}>
          <svg className="w-5 h-5 mb-1" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M4 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2V6zM14 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2V6zM4 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2v-2zM14 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2v-2z"></path></svg>
          <span className="text-[10px] font-bold">Grid</span>
        </button>
        <button onClick={() => setActiveTab('reservations')} className={`flex flex-col items-center justify-center w-full h-full ${activeTab === 'reservations' ? 'text-primary' : 'text-text-muted'}`}>
        ...
        <button onClick={() => setActiveTab('profiles')} className={`flex flex-col items-center justify-center w-full h-full ${activeTab === 'profiles' ? 'text-primary' : 'text-text-muted'}`}>
        ...
        <button onClick={() => setActiveTab('maintenance')} className={`flex flex-col items-center justify-center w-full h-full ${activeTab === 'maintenance' ? 'text-primary' : 'text-text-muted'}`}>
